    ...
    <div>
        <div id="test2">
            ...
            <form action="/user/registerSubmit" method="get">
                ...
                Email <input type="text" name="email" id="emailId" placeholder="Email@email.com" value="${form.email}">
                <c:forEach items='${bindingResult.getFieldErrors("email")}' var="error">
                    <div style="color:red;">${error.getDefaultMessage()}</div>
                </c:forEach>
                <br>
                First Name <input type="text" name="firstName" id="firstNameId" placeholder="John" value="${form.firstName}">
                <c:forEach items='${bindingResult.getFieldErrors("firstName")}' var="error">
                    <div style="color:red;">${error.getDefaultMessage()}</div>
                </c:forEach>
                <br>
                Last Name <input type="text" name="lastName" id="lastNameId" placeholder="Barty" value="${form.lastName}">
